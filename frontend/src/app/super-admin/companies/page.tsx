...
// CompaniesTable will be created next
          ...
          <div className="space-y-6 px-6 py-6 sm:px-8 sm:py-8">
            <section className="overflow-hidden rounded-[1.25rem] border border-zinc-200 bg-white p-6 dark:border-zinc-800 dark:bg-zinc-950 sm:p-8">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm uppercase tracking-[0.24em] text-zinc-500 dark:text-zinc-400">Companies</p>
                  <h1 className="mt-2 text-2xl font-semibold text-zinc-950 dark:text-white">Company Management</h1>
                </div>
              </div>
