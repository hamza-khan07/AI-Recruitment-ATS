...
export function Sidebar({
  ...
  const sidebarContent = (
    <div className="flex h-full flex-col">
        ...
        <div className="flex items-center gap-3">
          ...
          {!collapsed && (
            <div>
              ...
              <p className="text-xs text-zinc-500 dark:text-zinc-400">Portal</p>
            </div>
          )}
        </div>
      ...
      <div className="border-t border-zinc-200 p-3 dark:border-zinc-800">
        <button className="flex w-full items-center gap-3 rounded-2xl px-3 py-2.5 text-sm font-medium text-zinc-600 transition hover:bg-zinc-100 hover:text-zinc-950 dark:text-zinc-400 dark:hover:bg-zinc-800 dark:hover:text-white">
  ...
  return (
    <>
      <aside
        className={cn(
          "fixed inset-y-0 left-0 z-40 border-r border-zinc-200 bg-white transition-all duration-300 dark:border-zinc-800 dark:bg-zinc-950 lg:static lg:h-screen lg:translate-x-0",
          collapsed ? "w-20" : "w-72",
